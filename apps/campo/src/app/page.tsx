...
function CampoLanding() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-primary selection:text-black pb-20 font-sans">
      <section className="relative pt-32 pb-20 px-6 sm:px-12 lg:px-24 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full justify-center max-w-lg mb-20">
          <Link
            href="/pos"
            className="inline-flex justify-center items-center gap-3 w-full sm:w-auto px-10 py-5 bg-primary hover:bg-primary/90 text-black rounded-full font-bold shadow-2xl shadow-primary/20 transition-all transform hover:scale-105"
          >
            Abrir POS
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl text-left">
          <div className="bg-stone-900/40 backdrop-blur-xl p-8 rounded-3xl border border-stone-800/50 shadow-2xl group hover:border-primary/30 transition-all">
