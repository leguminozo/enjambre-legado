...
<div style={{ padding: 'var(--space-md)', borderRadius: 'var(--radius-sm)', background: 'hsl(var(--success) / 0.08)', textAlign: 'center' }}><div style={{ fontSize: '1.3rem', fontWeight: 700, color: 'hsl(var(--success))' }}>{sc.production}</div><div style={{ fontSize: '0.72rem', color: 'hsl(var(--muted-foreground))' }}>Producción</div></div>
          <div style={{ padding: 'var(--space-md)', borderRadius: 'var(--radius-sm)', background: 'hsl(var(--accent) / 0.1)', textAlign: 'center' }}><div style={{ fontSize: '1.3rem', fontWeight: 700, color: 'hsl(var(--accent))' }}>{sc.revenue}</div><div style={{ fontSize: '0.72rem', color: 'hsl(var(--muted-foreground))' }}>Ingresos</div></div>
                        </div>
                    ...
                    <div className="ai-panel animate-in delay-5">
                        <div className="ai-panel-header"><Crown size={18} style={{ color: 'hsl(var(--accent))' }} /><span className="ai-panel-title">La Reina · Asistente Inteligente</span></div>
