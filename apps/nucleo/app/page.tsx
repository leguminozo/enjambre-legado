      ...
      <section className="relative pt-32 pb-20 px-6 sm:px-12 lg:px-24 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center max-w-md">
          <Link href="/login" className="w-full">
            <button className="w-full px-8 py-4 bg-[var(--bosque-ulmo)] hover:bg-[var(--bosque-ulmo-light)] text-white rounded-2xl font-medium transition-all duration-300 shadow-xl shadow-[var(--bosque-ulmo)]/20 active:scale-95 flex justify-center items-center gap-2 group">
