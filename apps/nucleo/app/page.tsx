...
export default function NucleoLanding() {
  ...
  return (
    <main className="min-h-screen bg-[var(--crema-warm)] text-foreground font-sans selection:bg-[var(--oro-miel)] selection:text-primary-foreground pb-20">
      <section className="relative pt-32 pb-20 px-6 sm:px-12 lg:px-24 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="z-10 bg-surface-raised/40 border border-border/60 backdrop-blur-md px-4 py-1.5 rounded-full inline-flex items-center gap-2 mb-8 shadow-sm">
          <span className="w-2 h-2 rounded-full bg-[var(--oro-miel)] animate-pulse" />
          <span className="text-sm font-medium text-[var(--bosque-ulmo)]">Monitoreo en Tiempo Real Operativo</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center max-w-md">
          <Link href="/login" className="w-full">
            <button className="w-full px-8 py-4 bg-[var(--bosque-ulmo)] hover:bg-[var(--bosque-ulmo-light)] text-primary-foreground rounded-2xl font-medium transition-all duration-300 shadow-xl shadow-[var(--bosque-ulmo)]/20 active:scale-95 flex justify-center items-center gap-2 group">
      ...
      <section className="px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-surface-raised/60 p-8 rounded-3xl border border-border backdrop-blur-xl shadow-lg shadow-[var(--bosque-ulmo)]/5 hover:-translate-y-1 transition-transform duration-300">
